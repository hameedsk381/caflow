      ...
      <div className="w-full max-w-[440px] z-10 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="flex flex-col items-center text-center space-y-4">
          <div className="h-16 w-16 rounded-none bg-blue-600 flex items-center justify-center text-white shadow-none border border-white/10 group cursor-default">
            <Crown className="h-8 w-8 fill-current group-hover:scale-110 transition-transform" />
          </div>
          <div className="space-y-1">
            <h1 className="text-4xl font-black tracking-tighter text-white uppercase italic">CAFlow</h1>
            <p className="text-blue-500 text-[10px] font-black uppercase tracking-[0.3em] ml-1">Enterprise Practice Terminal</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-none p-10 space-y-8 shadow-none border-t-4 border-blue-600">
          <div className="space-y-2">
             ...
             <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest">Global Practitioner Authentication Required</p>
          </div>

          <div className="p-5 rounded-none bg-slate-50 border border-slate-200">
            ...
            <div className="space-y-1.5 text-[11px] font-black text-slate-700 uppercase tracking-tight">
                <p>Identity: <span className="text-blue-600">admin@caflow.demo</span></p>
                <p>Passphrase: <span className="text-blue-600">demo1234</span></p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full h-12 bg-white border border-slate-200 rounded-none pl-12 pr-4 text-sm font-black focus:outline-none focus:border-blue-600 transition-all text-[#0f172a] placeholder:text-slate-300 uppercase"
                  value={form.email}
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  required
                  placeholder="••••••••"
                  className="w-full h-12 bg-white border border-slate-200 rounded-none pl-12 pr-4 text-sm font-black focus:outline-none focus:border-blue-600 transition-all text-[#0f172a] placeholder:text-slate-300"
                  value={form.password}
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full h-12 bg-[#0f172a] text-white rounded-none font-black text-[11px] uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-slate-800 shadow-none transition-all active:scale-[0.98] disabled:opacity-50"
            >
